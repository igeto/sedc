...
function alertUser(shouldAlert, message) {
 ...
 if(!alertUser(willLevelUp(125, 160, 40), "asdasda")) {
 	alertUser(!willLevelUp(125, 160, 40), "You have not leveled up!");
 } else
 	alertUser(willLevelUp(125, 160, 40), "You have leveled up!");